...
const AiDeploymentsPage = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(`/api/ai-deployments/${state.selectedRowId}`, {
        method: "DELETE",
      });
    ...
    <>
      {state.toastOpen && (
        <ActionableNotification
          ...
          className={`${styles.customToast} ${styles.toastNotification}`}
        />
      )}
      <PageHeader
                          ...
                          <li className={styles.columnFilterMenu} role="none">
                            ...
                            <CheckboxGroup legendText="">
                              <Checkbox
                                ...
                                id="column-name"
                                checked={state.visibleColumns.name}
                                disabled={true}
                                onChange={() =>
                                  dispatch({
                              ...
                              <Checkbox
                                labelText="Status"
                                id="column-status"
                                checked={state.visibleColumns.status}
                                onChange={() =>
                                  dispatch({
                                    type: ACTION_TYPES.TOGGLE_COLUMN_VISIBILITY,
                                    payload: "status",
                              ...
                              <Checkbox
                                labelText="Uptime"
                                id="column-uptime"
                                checked={state.visibleColumns.uptime}
                                onChange={() =>
                                  dispatch({
                                    type: ACTION_TYPES.TOGGLE_COLUMN_VISIBILITY,
                                    payload: "uptime",
                              ...
                              <Checkbox
                                labelText="Messages"
                                id="column-messages"
                                checked={state.visibleColumns.messages}
                                onChange={() =>
                                  dispatch({
                                    type: ACTION_TYPES.TOGGLE_COLUMN_VISIBILITY,
                                    payload: "messages",
                            ...
                            return (
                              <TableRow key={rowKey} {...rowProps}>
                                {row.cells.map((cell) => {
                                  ...
                                  if (cell.info.header === "messages") {
                                    const message = cell.value as string;
                                    if (!message) {
                                      return (
                                        <TableCell key={cellKey} {...cellProps}>
                                          {message}
